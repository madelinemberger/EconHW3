...
$Average~Bid = 0.5 + `r round(y_int, digits = 4)` + `r round(age50, digits=4)`(age~to~50) + `r round(nep, digits=4)`(NEP) -  + `r round(risk, digits=4)`(60) / `r round(bid, digits=4)`$  
...
So, if there are 150,000 households in Santa Barbara County, thetotal benefit of a VSR program is estimated as $39,485,302.1.
